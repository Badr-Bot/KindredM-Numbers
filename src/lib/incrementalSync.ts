...
// v5 (17/08) : le contrôle v4 a prouvé que TOUS les ids des lots refusés sont
// en base — l'upsert PARTIEL {id, fee_*} part quand même en INSERT (23502
// « store null »), cause côté base non identifiée. Contournement sûr : en cas
// de 23502, bascule en UPDATE par commande (ne peut pas violer un NOT NULL
// qu'il ne touche pas). Ce bump relance le rattrapage complet.
const REQUIRED_FEES_BACKFILL_VERSION = "2026-08-17-frais-reels-historique-v5";
