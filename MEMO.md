...
- **Claude Badr : DEUX abonnements à 100 €/mois.** Abo 1 depuis le 15/07, abo 2 depuis le 08/08 (montant assumé 100 €, à confirmer). **Seule la 1re facture (15/07, 100 €) est sortie de la poche de Badr** — depuis le 08/08 la CARTE LLC paie tout → le compteur d'avances Claude de Badr reste à 100 €, définitivement (sauf nouvelle facture perso annoncée). Le tracé « Entre associés » compte les FACTURES réelles (SUB_PAYMENTS), jamais un cumul théorique — un cumul accru depuis le 04/06 affichait 217 € vs 100 € réellement payés, corrigé sur remarque de Badr.
