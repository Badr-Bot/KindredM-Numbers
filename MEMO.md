...
- **Ce qu'il reste à donner par vente** : le NOMBRE DE PACKS (plus le COGS). Une seule valeur est encore déduite et non lue — le bundle de #1003 (118,75 $ → 3 packs, d'après l'échelle de prix 45,67 / 81,29 / 118,75 qui progresse d'environ +36 $/pack). Écart 3↔4 packs = 8,77 $ de COGS.
