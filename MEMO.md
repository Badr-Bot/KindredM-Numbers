...
- Ledger démarre aux factures **20260801 (14 279,96 €, #4814-5462)** et **20260814 (12 064,41 € dont 410 € de « custom packing », #5463-5995)**. Tout ce qui précède = réputé soldé. Statuts (`a_payer`/`partielle`/`payee`) et paiements mis à jour À LA MAIN quand Badr l'annonce — jamais déduits. **Bill 20260801 : PAYÉE** (virement 16 388,40 $ le 06/08, settled, taux impliqué 1,1476 — annoncé par Badr le 14/08 avec capture). **Bill 20260814 : correction demandée** (gilet contesté), paiement en attente de la facture corrigée.
