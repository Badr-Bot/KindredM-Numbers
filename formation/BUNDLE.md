...
> Fichier **généré** par `scripts/formation-bundle.mjs` le 2026-08-13.
...
**État du corpus** : 1 leçon(s) — 1 brut.


> ⚠️ **Leçons non validées** (statut ≠ `ok`) : MB-12.
> Leur contenu est partiel. Signale-le quand tu t'appuies dessus.


## Sommaire

- `MB-12` — L'algorithme Meta, ce que personne ne t'explique *(brut)*

---

<!-- source: formation/notes/media-buying/12-l-algorithme-meta.md | statut: brut -->
