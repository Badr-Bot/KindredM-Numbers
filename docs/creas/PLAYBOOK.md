...
- **6. Suspense Mis en Scène** — Concept : « Créez une attente que "quelque chose va se produire" — cela pousse les spectateurs à rester jusqu'au bout. » Exécution : créez de la tension sans réel danger ; utilisez des angles de caméra (idéalement POV) pour suggérer un risque ; donnez l'impression que quelque chose est sur le point d'arriver ; résolvez la tension avec votre message. Type de hook le plus performant selon Matteo, à ne pas sur-utiliser.
...
- **Vs. (generic solutions)** — Comparatif contre les solutions génériques du marché. Statut « Winner » sur l'axe Practical.
